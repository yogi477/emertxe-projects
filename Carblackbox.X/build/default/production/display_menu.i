...
void display_main_menu(void)
{
    ...
    clcd_print(disp_menu[disp_index],(0x80 + (3)));
     clcd_print(disp_menu[disp_index+1],(0xC0 + (3)));
     if(key == 1)
     {
         clcd_write(0x01, 0);
         if(flag == 0)
     ...
     else if(key == 11 && menu_cnt == 0)
     {
         clcd_write(0x01, 0);
         state = e_view_log;
     }
     else if(key == 11 && menu_cnt == 1)
     {
         clcd_write(0x01, 0);
         state = e_clear_log;
     }
     else if(key == 11 && menu_cnt == 2)
     {
         clcd_write(0x01, 0);
         state = e_download_log;
     }
     else if(key == 11 && menu_cnt == 3)
     {
         clcd_write(0x01, 0);
         state = e_set_time;
     }
