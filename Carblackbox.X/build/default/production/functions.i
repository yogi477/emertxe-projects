...
void view_dashboard(void) {
    ...
    clcd_print("GEAR", (0x80 + (9)));
    clcd_print(gears[gear_index], (0xC0 + (9)));

    clcd_print("SP", (0x80 + (14)));
    clcd_putch((adc_val / 10) + 48, (0xC0 + (14)));
    clcd_putch((adc_val % 10) + 48, (0xC0 + (15)));
...
void view_log(void) {
    if (event_cnt == 0) {
        ...
        clcd_print("#", (0x80 + (0)));
        clcd_print("Time", (0x80 + (3)));
        clcd_print("GR", (0x80 + (11)));
        clcd_print("SP", (0x80 + (14)));
        clcd_putch(num_cnt + 48, (0xC0 + (0)));
        static once = 1;
        if (once) {
        ...
        if (key == 1 && (count1 < event_cnt - 1)) {
            event_read();
            count1++;
            num_cnt++;
        }
        else if (key == 2 && (count1 > 0)) {
